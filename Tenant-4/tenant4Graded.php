...
else
{
  ...
  $query1 .= "VALUES ('4', 'SCALED_GRADE','$scale','$points','$status','$comments')";

  $query2  = "INSERT INTO TENANT_TABLE (TENANT_ID, TABLE_NAME, TABLE_DESC)";
  $query2 .= "VALUES ('4', 'Paul','Scaled_Graded')";
  
  $query3  = "INSERT INTO SCALED_GRADE (DESCRIPTION, OWNER, Scale, Points, Completion_Status, Comments)";
  $query3 .= "VALUES ('Scaled_Graded','Paul','$scale','$points','$status','$comments')";
 ...
 <!--Form Starts -->
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-10 col-md-7 col-lg-6">
       ...
       <legend>Grade Submitted for Tenant-4</legend>
          
             <div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Grading Details for Paul Nguyen</h3>
  </div>
