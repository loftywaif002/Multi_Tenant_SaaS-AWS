...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!ADD MORE LINKS HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->                                                  
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Generated Diagram For Tenant-4</h4>
      </div>
      
      <div class="modal-body">
    <?php
   
    $dir  = "./"; // your folder name ex: image
    $imgs = glob($dir ."my_sequence_diagram.png"); // get your image files with .jpg 
   
    foreach ($imgs AS $i) {
      echo "<img width='50%' src='$i'>"; // 
    }
     ?>    
      </div>
 ...
 <!--MODAL-ENDS-->  
    ...
    <div class="col-xs-12 col-sm-10 col-md-7 col-lg-6">
       ...
       <legend>Click Generate Button To Generate The Diagram</legend>
  ...
  <div class="form-group">
    ...
    <small id="fileHelp" class="form-text text-muted">Acceptable file Format is .txt</small>
  </div>

   <button type="submit" name="generate" class="btn btn-primary">Generate</button>
    <a href="#" class="btn btn-success" data-toggle="modal" data-target="#smallModal">Show Image</a>
      <!-- PROGRESS BAR-->
   <!-- Progress bar holder -->
...
<!-- PROGRESS BAR-->
      ...
      <form class="form-vertical" role="form" method="post" action="tenant4Graded.php">
        
        <fieldset>
         <legend>Submit Grade For Tenant-4 (Paul Nguyen)</legend>
          <div class="form-group">
...
//Refresh the page
echo '<script language="javascript">window.location.href="http://localhost:8888/MultiTenantSaas/tenant4.php";</script>';
