...
else
{
  ...
  $query1  = "INSERT INTO TENANT_DATA (TENANT_ID, TENANT_TABLE, COLUMN_2, COLUMN_3, COLUMN_4)";
  $query1 .= "VALUES ('2', 'SCALED_GRADE','$points','$status','$comments')";

  $query2  = "INSERT INTO TENANT_TABLE (TENANT_ID, TABLE_NAME, TABLE_DESC)";
  $query2 .= "VALUES ('2', 'Amita','Scaled_Graded')";
  
  $query3  = "INSERT INTO NON_SCALED_GRADE (DESCRIPTION, OWNER, Points, Completion_Status, Comments)";
  $query3 .= "VALUES ('Non_Scaled_Graded','Amita','$points','$status','$comments')";
 ...
 <!--Form Starts -->
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-10 col-md-7 col-lg-6">
       ...
       <legend>Grade Submitted for Tenant-2</legend>
          
             <div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Grading Details for Amita Kamat</h3>
  </div>
