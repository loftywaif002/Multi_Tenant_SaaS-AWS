...
<div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h4 class="modal-title" id="myModalLabel">Generated Diagram For Tenant-2</h4>
      </div>
      <div class="modal-body">
           <?php
    $dir  = "./Amita/Output-Diagrams"; // your folder name ex: image
    $imgs = glob($dir ."/tenant2.jpg"); // get your image files with .jpg 
...
<!-- PROGRESS BAR-->
      ...
      <form class="form-vertical" role="form" method="post" action="tenant2Graded.php">
        
        <fieldset>
         <legend>Submit Grade For Tenant-2 (Amita Kamat)</legend>
           <div class="form-group">
...
if($_FILES["zip_file"]["name"]) {
  ...
  $targetdir = $path . "uml-parser-test-amita"; // target directory
...
if(move_uploaded_file($source, $targetzip)) {
  ...
  if ($x === true) {
    ...
    unlink($targetzip);
      ...
      //Progress bar starts
$SourceFile =$path.'/Amita/UMLParser/src/';
chdir($SourceFile);
$script = 'java -jar UmlParser.jar /'.$targetdir.'/ tenant2.jpg' ;
shell_exec($script);
      // Total processes
$total = 10;
