...
<div class="modal fade" id="basicModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h4 class="modal-title" id="myModalLabel">Generated Diagram For Tenant-1</h4>
      </div>
      <div class="modal-body">
           <?php
    $dir  = "./images"; // your folder name ex: image
    $imgs = glob($dir ."/tenant1.png"); // get your image files with .jpg 
...
<!-- PROGRESS BAR-->
      ...
      <form class="form-vertical" role="form" method="post" action="tenant1Graded.php">
        
        <fieldset>
         <legend>Submit Grade For Tenant-1 (Rashmi Sharma)</legend>
          <div class="form-group">
...
if($_FILES["zip_file"]["name"]) {
  ...
  $targetdir = $path . "uml-parser-test-rashmi"; // target directory
